package com.tomkeuper.bedwars.addon.menu.menus;
...
import com.tomkeuper.bedwars.addon.tasks.ActionBarTask;
import com.tomkeuper.bedwars.addon.util.NBTItem;
import com.tomkeuper.bedwars.addon.util.TextUtil;
...
public class TrackerMenu extends Menu {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (nbtItem.getString("data").equals("main-menu")) {
            if (backToShop) {
                ShopManager.shop.open(player, PlayerQuickBuyCache.getInstance().getQuickBuyCache(player.getUniqueId()), false);
            }else {
